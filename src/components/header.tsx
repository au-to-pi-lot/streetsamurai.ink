...
const Header = (): React.JSX.Element => (
    <header className="relative text-center w-full [transform-style:preserve-3d] flex flex-col items-center justify-evenly px-4 pt-4">
        <div className="w-full h-full flex items-center justify-between">
            <h1 className={`${LibreBarcode128Text.className} tracking-tighter whitespace-nowrap text-header sm:text-header-lg inline-block z-[2] leading-none filter drop-shadow-[0_1px_5px] glitch layers border-2 p-2`}
